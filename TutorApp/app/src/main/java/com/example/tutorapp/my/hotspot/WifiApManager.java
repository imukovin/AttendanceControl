...
public class WifiApManager {
     ...
     * mode operation
     *
     * @param wifiConf SSID, security and channel details as part of WifiConfiguration
     * @return {@code true} if the operation succeeds, {@code false} otherwise
     */
    public boolean setWifiApEnabled(WifiConfiguration wifiConf, boolean enabled) {
        try {
            if (enabled) {
                mWifiManager.setWifiEnabled(false); // выключить wifi
            }
            Method method = mWifiManager.getClass().getMethod("setWifiApEnabled",
                    WifiConfiguration.class,
                    boolean.class);
            return (Boolean) method.invoke(mWifiManager, wifiConf, enabled);
        } catch (Exception e) {
